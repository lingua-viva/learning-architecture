...
# ---------------------------------------------------------------------------
# Indicator taxonomy — SINGLE SOURCE, shared with docpipe/lens_extract.py.
# Moved to safeguarding_indicators.py on 2026-09-03 because this repository
# carried three independent safeguarding vocabularies that disagreed; see that
# module's docstring for the measured consequence. Re-exported here so every
# existing import of RED_INDICATORS / AMBIGUOUS_INDICATORS / AMBER_INDICATORS
# keeps working unchanged.
# ---------------------------------------------------------------------------

from src.lingua_viva.safeguarding_indicators import (  # noqa: E402
    AMBER_INDICATORS,
