...
def _generic_detail(event_type: str) -> str:
    details = {
        ...
        "profile_updated": "A student profile was edited by the teacher and saved locally only.",
        "support_entry_confirmed": "A suggested support-profile entry was confirmed by the teacher.",
        ...
        "voice_sent_to_external_tts": "Text was sent to the Rime speech service to be read aloud. It was checked for student information first.",
        "voice_kept_local_student_data": "Text mentioning a student was read aloud by this computer instead of being sent to the Rime speech service.",
        ...
        "ledger_pulled": "Colleague observation ledgers were checked in the school's shared Drive folder.",
        "observations_imported": "Colleague observations were merged into a local student lens, with the original author kept.",
